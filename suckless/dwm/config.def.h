...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_f,      spawn,          SHCMD("dbus-run-session thunar") },
...
static const Button buttons[] = {
  ...
  { ClkRootWin,           MODKEY,         Button9,        view,           { .i = +1 } },  // Go to the next workspace
  { ClkRootWin,           MODKEY,         Button8,        view,           { .i = -1 } },  // Go to the previous workspace
